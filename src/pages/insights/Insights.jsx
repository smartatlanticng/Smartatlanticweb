...
function Insights() {
    ...
    const categories = Array.from(
      new Set(Blogs.map((res) => res.category) )
    )
    ...
    // const filterBlogs = selectedCategory ? Blogs.filter((res) => res.category === selectedCategory.value):res;
                ...
                <div className="card">
                  ...
                  <div className="card-date">
                    <div className="card-date-top">
                      <div className="day">{dayjs(blog.date).format("DD")}</div>
                    <div className="myr">{dayjs(blog.date).format("MMM, YY")}</div>
                    </div>
                    <div className="triangle-topleft"></div>
                  </div>
                  
                  <div className="card-info">
                    <Link to="/"><h5>{blog.title}</h5>
                    <p>{blog.excerpt}</p></Link>
                  </div>
                </div>
              </div>
              )
